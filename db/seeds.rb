...
(1..200).each do |index|
  ...
  student=User.create!(
      ...
      num: "2017#{Faker::Number.number(11)}",
      major: department_map[dept][:major_name].sample,
      department: dept,
      student_class: 20170713,
      reset: false,
      password: "password",
      password_confirmation: "password",
  )
...
（中国科学院大学40周年校庆公告002号）
    ...
    2018年是中国科学院大学（简称“国科大”）建校四十周年，为客观记录和展示学校教育发展历程，探寻办学历史及文化内涵，全方位展示学校办学特色及育人成果，传承学校文化，弘扬学校传统，国科大决定筹建新校史馆，现向全体师生、离退休职工及家属、海内外校友和社会各界人士广泛征集校史资料。具体征集内容如下。
...
五、征集时间
    ...
    2. 对于有意愿在国科大校庆活动日（2018年10月14日）展示的校史资料，请提供者于2018年3月16日前联系国科大校史馆或校友会办公室，办理送交手序。
...
Inform::Article.create!(
    ...
    2018年全国硕士研究生入学考试将于2017年12月23-24日举行，我校是考点之一。

    为保证国家教育考试的顺利进行，决定从2017年12月22日17：00开始至23日18：00，对中关村教学楼进行封闭；从12月22日17：00开始至24日18：00，对玉泉路教学楼（含辅楼阶梯教室）和人文楼进行封闭。封闭期间，与考试无关的人员一律不得进入封闭区域。
...
Inform::Article.create!(
    title:"关于举行中国科学院大学2017级新生开学典礼的通知",
    text:"

各研究所：    中国科学院大学定于2017年9月10日（星期日）上午9:00，在雁栖湖校区图书馆楼前广场，举行2017级新生开学典礼。典礼由中科院副院长、国科大校长丁仲礼院士主持，中科院院长、国科大名誉校长白春礼院士出席并讲话。    建议京外研究所组织学生通过点击中国科学院大学中文网首页的飘窗收看开学典礼视频直播，或结合本单位实际情况自行组织开学典礼。    视频直播调试时间：2017年9月9日15:00至18:00，请各所测试收看效果，有问题及时反馈。特此通知。                   中国科学院大学                   2017年9月6日 
"
)
